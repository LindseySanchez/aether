...
const entries = [
  ...
  },
  {
    ...
    sources: ["Hesiod, Theogony 453-506, 617-735, 881-929", "Homer, Iliad 1.1-52, 8.1-40, 15.1-33, 24.1-76, 15.187-199 (division of the cosmos)", "Apollodorus, Library 1.1.2-2.1.2", "Pindar, Olympian 1 and 2 (for related themes of justice and fate)"],
    variants: "The extent of Zeus's power and the degree to which he is subject to fate varies across authors. In some traditions he appears more limited; in others he is identified with cosmic order itself. The binding of Zeus by Hera, Poseidon, and Athena (Iliad 1.396-406 with the help of Thetis and Briareus) shows even the king of the gods can be temporarily constrained. Local traditions in Crete emphasized his birth and death more than his kingship. Orphic and philosophical traditions sometimes present a more abstract or pantheistic Zeus. In some Hellenistic syncretisms he was identified with Ammon, Serapis, and other supreme gods of the East.",
    symbols: ["Thunderbolt", "Eagle", "Oak", "Aegis", "Scales of Justice"],
    relations: [
